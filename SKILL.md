...
```text
/xxd-panel-102 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，102 设计在下）
2. 左右对照（原图在左，102 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-102/<fresh-task>/
...
- `references/xxd-panel-102-prompt.zh-CN.md`
- `references/xxd-panel-102-prompt.en.md`
