<p align="center"><img src="./assets/banner.svg" alt="XXD Panel 102 project banner" width="1200"></p>
...
| **[xxd-panel-102](https://github.com/nevertoday/xxd-panel-102)** | Healing Geometry Journal · geometrised subject · clear flat colour · positive–negative shape · generous whitespace · restrained micro-annotations |
...
| **Soldiers** | `xxd-panel-NNN` (currently 001–102) | Each numbered Skill executes only its own original brief and aesthetic, completing the individual job assigned by the General. |
