<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 102" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 102｜مجلة هندسة السكينة

### يستخلص من الصورة هندسة هادئة وواضحة ومفعمة بالحياة
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 102 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

يناسب **Panel 102** من يريد الحفاظ على قابلية التعرّف على موضوع الصورة مع التخلص من الخلفيات المزدحمة وإعادة الرسم الواقعية والمرشحات الرخيصة. يختزل المحيط والبنية والوضعية والعلاقات الجوهرية في مساحات لونية هندسية قليلة، ليصنع ضمن فراغ صافٍ ملصقاً تحريرياً هادئاً وحديثاً ومفعماً بالحياة والسكينة.

### مناسب لـ

- توضيح صورة مزدحمة عبر الاحتفاظ بالمحيط والبنية والوضعية والعلاقة الأكثر قابلية للتعرّف؛
- صنع إحساس حديث وراقٍ من دون برودة، باستخدام الشكل الإيجابي والسلبي والتسلسل الهرمي والفراغ الواسع؛
- استبدال ألوان المرشحات الكدرة أو الرخيصة بألوان مشرقة ونقية ودافئة مشتقة من الأصل؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات؛

### بداية سريعة

> استخدم XXD Panel 102 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** تجريد هندسي · لون مسطّح · محيط واضح · شكل إيجابي وسلبي · فراغ واسع · نظام تحريري مريح
...
|---|---|
| **الناتج** | ملصق تحريري حديث يحمل ذكرى الصورة عبر أشكال هندسية قليلة ولون صافٍ وفراغ عقلاني |
| **البصمة الواضحة** | موضوع هندسي، مساحات لونية مسطحة، محيط واضح، تعليقات دقيقة، أرضية فاتحة، وفراغ واسع |
| **احترام المصدر** | يحافظ على السمات والوضعية والعلاقات الجوهرية، فيظل التصميم مرتبطاً فوراً بالصورة الحالية |
| **الاستخدامات** | محتوى العلامات وملصقات المعارض والعمارة وذكريات الأشخاص أو الحيوانات والأغلفة والمحتوى الاجتماعي وخلفيات الأجهزة |
<!-- xxd-panel-benefit:end -->

## منطق التحويل

```text
تحديد المحيط والبنية والوضعية الجوهرية → حذف التفاصيل الثانوية → الاختزال إلى أشكال هندسية ومساحات لونية قليلة → ضبط الشكل الإيجابي والسلبي والثقل البصري وإيقاع الفراغ → اشتقاق لون مشرق ومريح من الأصل → الإنهاء بعنوان أو رقم أو تعليق دقيق ومنضبط
```

## سمات النتيجة النهائية

- تحافظ أشكال هندسية قليلة ومحيطات واضحة وعلاقات الخط الرفيع على الهوية والوضعية الأساسيتين للموضوع.
- يجعل مركز الثقل والتسلسل الهرمي والشكل الإيجابي والسلبي وتوازن الصورة والنص التكوين هادئاً لا فارغاً.
- تترك الأرضية العاجية أو الفاتحة المطابقة بذكاء فراغاً واسعاً ليبدو الموضوع كعينة ذاكرة منظّمة.
- تبقى المساحات اللونية المشرقة والنقية والدافئة المشتقة من الأصل واضحة ولطيفة؛ وتتجنب الرمادي الكدر والعتمة والفلورية وألوان الحلوى الرخيصة.
- تكون العناوين والأرقام والتعليقات الدقيقة قليلة وراقية بروح استوديو التصميم وملصق المعرض؛ وتتجنب الواقعية والكرتون والخامة البلاستيكية وزينة القوالب.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-102-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 102. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-102 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-102 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-102 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-102 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-102 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 102 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-102 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-102`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-102-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-102-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ102 على موجّهه الأصلي ومنطقه الجمالي المستقل. يعرض الجدول روابط جميع المشاريع وخصائص أسلوبها الأساسية، مع تمييز المشروع الحالي بخط عريض.
...
| **[xxd-panel-102](https://github.com/nevertoday/xxd-panel-102)** | مجلة هندسة السكينة · موضوع هندسي · لون مسطّح صافٍ · شكل إيجابي وسلبي · فراغ واسع · تعليقات دقيقة منضبطة |
...
### القيادة العامة لـ Xiaoxiaodong · Skill القائد العام · 102 يوان صيني

تمنحك دفعة واحدة قدرها 102 يوان صيني Skill القائد العام لهذه السلسلة (`xxd-panel-all`) لإدارة جميع Skills الجنود والتوصية بها واستدعائها وتنسيق العمل الدفعي. اكتب «Skill القائد العام» في رسالة WeChat.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–102) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
